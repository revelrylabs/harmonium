...
const URL_FUNCTIONS = {
  ...
  PINTEREST: (url, text) => `https://pinterest.com/pin/create/bookmarklet/?url=${url}&description=${text}`,
  REDDIT: (url, text) => `https://reddit.com/submit?url=${url}&title=${text}`,
  TUMBLR: (url, text) => `https://www.tumblr.com/widgets/share/tool?canonicalUrl=${url}&caption=${text}`,
