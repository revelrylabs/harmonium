 ...
 */
function calculateMonthClass(date: DateTime, currentMonth: string): string {
  const modifier =
...
function calculateSelectionClass(
 ...
 * @return {string} - a class to use for styling
 */
function calculateHighlightClass(
  date: DateTime,
  ...
  return (
    configMapping(
      highlights || {},
      date,
      (dateArg: DateTime) => dateArg.toISODate(),
