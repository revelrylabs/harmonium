  ...
  render() {
    return (
      <div>
        <h1>Grid</h1>
        <p>
          Note: the examples on this page have been specifically styled to make normally invisible
          grid elements visible. These non-standard styles:
        </p>
        <ul>
          <li>
          ...
          <li>
            The left and right edges of the columns have been marked with a dashed line to
            demonstrate the extent of the grid gutters.
          </li>
          <li>Nested grid rows have been given a white outline to demonstrate their bounds.</li>
        </ul>
