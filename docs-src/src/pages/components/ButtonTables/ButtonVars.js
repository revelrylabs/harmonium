    ...
    <Table>
      ...
      <Table.Body>
        <Table.Row>
          ...
          <Table.Data>
            <Table.HeaderInline>Default Value:</Table.HeaderInline> <code>$color-brand</code>
          </Table.Data>
          <Table.Data>
        ...
        <Table.Row>
          ...
          <Table.Data>
            <Table.HeaderInline>Default Value:</Table.HeaderInline> <code>darken($color-brand, 5%)</code>
          </Table.Data>
          <Table.Data>
        ...
        <Table.Row>
          ...
          <Table.Data>
            <Table.HeaderInline>Default Value:</Table.HeaderInline> <code>$darken($color-brand, 10%)</code>
          </Table.Data>
          <Table.Data>
