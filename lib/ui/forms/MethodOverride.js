...
Rev.registerComponent('MethodOverride', (function (_React$Component) {
  _inherits(MethodOverride, _React$Component);

  function MethodOverride() {
    _classCallCheck(this, MethodOverride);

    return _possibleConstructorReturn(this, Object.getPrototypeOf(MethodOverride).apply(this, arguments));
  }
